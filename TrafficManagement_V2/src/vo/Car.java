...
public class Car {
    ...
    public Car(String carID, String fromCrossID, String toCrossID, String curFromCrossID, String curToCrossID, int maxVelocity, int planTime, int realStartTime, int realEndTime, String roadID, int laneID, int priority, int curPos, int sheng, boolean hasArrangedOrNot, int state, String nextRoadID, boolean canThrough) {
        this.carID = carID;
